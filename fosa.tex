...
\specialcomment{Beweis}{\begin{mdframed}[style=MyFrame,nobreak=true] Beweis: \ \\}{\end{mdframed}}
...
\paragraph{Numerische Berechnung des ML-Schätzers}
Fisher-scoring als statistische Version des Newton-Raphson-Verfahrens
