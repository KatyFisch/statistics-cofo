...
\begin{align*}
R(t(.), \theta) = &\: \mathrm{E}_\theta \left(\{t(Y) -\theta\}^2\right) \\
= &\: \mathrm{E}_\theta \left(\{t(Y) - \mathrm{E}_\theta(t(Y)) + \mathrm{E}_\theta(t(Y))-\theta\}^2\right) \\
= &\: \mathrm{E}_\theta \left(\{t(Y) - \mathrm{E}_\theta(t(Y))\}^2\right) +
\mathrm{E}_\theta \left(\{\mathrm{E}_\theta(t(Y))-\theta\}^2\right) \\
& +  2\mathrm{E}_\theta \left(\{t(Y)-\mathrm{E}_\theta \left(t(Y)\right)\}\{\mathrm{E}_\theta \left(t(Y)\right)-\theta\}\right) \\
= &\: \mathrm{Var}_\theta\left(t(Y_1,...,Y_n)\right) + Bias^2((t(.); \theta) + 0
\end{align*}
\end{Beweis}
