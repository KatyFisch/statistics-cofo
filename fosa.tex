...
\paragraph{Non-stationarity and Pairwise Interaction}

$$f(s_1,...,s_n|\theta) = \overbrace{a(\theta)}^{\text{normalising}}\prod_{i=1}^n \overbrace{b(s_i|\theta)}^{\text{trend}}\prod_{i<j}\overbrace{h(s_i,s_j|\theta)}^{\text{interaction}}$$
